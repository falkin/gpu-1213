...
Mat Capture_A::capturer(void)
    ...
    cvtColor(matCaptureSrc, matCaptureDest, CV_8U, 4); //CV_8U CV_RGB2GRAY // 0 keep same chanel // 4 permet par exemple d'ajouter la couche alpha à rvb (pour une video ou webcam)
